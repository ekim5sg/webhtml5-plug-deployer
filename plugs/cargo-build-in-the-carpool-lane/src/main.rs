...
fn app() -> Html {
    html! {use gloo::timers::callback::Timeout;
use js_sys::Math;
use web_sys::window;
use yew::prelude::*;
            ...
            for (idx, line) in script.into_iter().enumerate() {
                ...
                Timeout::new((idx as u32) * 520 + 180, move || {
                    ...
                    if idx == 9 {
                        ...
                        outcome.set(Some(outcome_final));
            ...
            <>
                ...
                <div class="section-box">
                    ...
                    <div class="card-subtitle" style="margin-top:8px;">
                        {"Optimized for screenshots, demo reels, and very specific LinkedIn humor."}
                    </div>
                </div>
            </>
        }
    ...
    yew::Renderer::<App>::new().render();
      ...
      <>
        <main style="font-family:system-ui; padding:24px;">
          <h1>"Cargo Build in the Carpool Lane"</h1>
          <p style="color:#667;">{"Plug scaffold is live. Replace this content with your real app."}</p>
          <p>"https://www.webhtml5.info/cargo-build-in-the-carpool-lane/"</p>
        </main>
      </>
    }
}
