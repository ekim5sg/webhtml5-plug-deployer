    ...
    html! {
        <article class={class_name}>
            ...
            <p class="central-note">
                {"Countdown ends at midnight Central Time"}
            </p>
        </article>
    }
}
...
fn app() -> Html {
    ...
    let celebration = active_celebration(*now);
    ...
    html! {
        <main class="app">
            ...
            <section class="countdowns">
                <Countdown kind={EventKind::Halloween} now={*now} />
                <Countdown kind={EventKind::Friday13} now={*now} />
            </section>
